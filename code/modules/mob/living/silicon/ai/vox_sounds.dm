...
GLOBAL_LIST_INIT(vox_sounds, list("," = 'sound/vox_fem/_comma.ogg',
"." = 'sound/vox_fem/_period.ogg',
...
"captured" = 'sound/vox_fem/captured.ogg',
...
"invallid" = 'sound/vox_fem/invallid.ogg',
...
"scores" = 'sound/vox_fem/scores.ogg',
...
"ventillation" = 'sound/vox_fem/ventillation.ogg',
