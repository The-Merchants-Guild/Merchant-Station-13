...
/datum/design/forge/forged_sword
	name = "Custom Sword"
	id = "fsword"
	materials = list(/datum/material/custom = 6000)
...
/datum/design/forge/forged_greatsword
	...
	id = "fgsword"
	materials = list(/datum/material/custom = 8000)
...
/datum/design/forge/forged_mace
	name = "Custom Mace"
	id = "fmace"
	materials = list(/datum/material/custom = 6500)
...
/datum/design/forge/forged_warhammer
	...
	id = "fwhammer"
	materials = list(/datum/material/custom = 10000)
...
/datum/design/forge/forged_bullet
	name = "Custom Bullet"
	id = "fbullet"
	materials = list(/datum/material/custom = 1000)
