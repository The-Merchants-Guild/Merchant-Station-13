...
//SPECIAL TRAITS|Somehow I feel like these could be rewritten to be components, but I am not learning how to make components just for this port
...
/datum/special_trait
	...
	var/desc //wow can you guess what this does
	...
	if(type && I)
		switch(type)
			if(FORGED_BULLET_CASING)
				var/obj/projectile/bullet/forged/F = I
				if(F.damage >= 20)
					F.projectile_piercing = PASSMOB
					F.projectile_phasing = (ALL & (~PASSMOB))
