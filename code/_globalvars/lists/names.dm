...
GLOBAL_LIST_INIT(hunter_demon_first_names, world.file2list("strings/names/hdemon1.txt"))
GLOBAL_LIST_INIT(hunter_demon_last_names, world.file2list("strings/names/hdemon2.txt"))
