//you know, as I sit here working on this, I realize that I originally was only meant to add floorcluwnes
...
/mob/living/simple_animal/hostile/gremlin/CanAttack(atom/new_target)
	...
	if(istype(new_target, /obj/machinery))
		...
		if(M.machine_stat & (NOPOWER|BROKEN)) //Unpowered or broken
			return FALSE
