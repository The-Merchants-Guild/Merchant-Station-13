...
/obj/effect/particle_effect/foam/Initialize(mapload)
	. = ..()
	create_reagents(1000) //limited by the size of the reagent holder anyway. Works without instant possibly edit in future
...
/datum/effect_system/foam_spread/New()
	..()
	chemholder = new /obj()
	var/datum/reagents/R = new/datum/reagents(1000) //same as above
