...
/obj/item/clothing/shoes/crowbar //basic syndicate combat boots for nuke ops and mob corpses
	...
	worn_icon_state = "crowbarshoes"
	strip_delay = 50
	resistance_flags = NONE
	permeability_coefficient = 0.05
	usesound = 'sound/items/crowbar.ogg'

/obj/item/clothing/shoes/crowbar/ComponentInitialize()
	. = ..()
	RegisterSignal(src, COMSIG_SHOES_STEP_ACTION, .proc/on_step)

/obj/item/clothing/shoes/crowbar/proc/on_step()
	SIGNAL_HANDLER
...
/obj/item/grown/bananapeel/lube/Initialize(AM)
	. = ..()
	AddComponent(/datum/component/slippery, 80, SLIDE, paralyze=80)
...
/obj/item/mop/advanced/energy
	...
	mopcap = 30
	refill_rate = 2
	attack_verb_simple = list("tapped", "poked")
	attack_verb_continuous = list("tapped", "poked")
	var/on = FALSE
...
/obj/item/mop/advanced/energy/proc/extend(user)
	...
	inhand_icon_state = "energymop_1"
	w_class = WEIGHT_CLASS_BULKY
	hitsound = "sound/weapons/blade1.ogg"
	attack_verb_simple = list("ferociously cleaned", "mopped up")
	attack_verb_continuous = list("ferociously cleaned", "mopped up")
	force = 23
...
/obj/item/blood_debt //guess the reference for a cookie
	name = "blood debt"
...
/obj/effect/proc_holder/spell/aimed/blood_debt
	...
	projectile_type = /obj/projectile/magic/aoe/blood_debt
	sound = 'sound/weapons/blood_debt.ogg'
...
/obj/effect/proc_holder/spell/aimed/blood_debt/Click()
	...
	if(user.stat != (SOFT_CRIT || UNCONSCIOUS || HARD_CRIT))
...
/obj/projectile/magic/aoe/blood_debt
	name = "HOLY SHIT"
...
/obj/projectile/magic/aoe/blood_debt/on_hit(target)
	. = ..()
	var/turf/T = get_turf(target)
	explosion(T, -1, 2, 3, 6, 0, flame_range = 4)
	if(ismob(target))
		var/mob/living/M = target
		priority_announce("[firer], age 45, gave themselves up to authorities after blowing up [target]. They are now serving a life sentence.","Blood Debt!", 'sound/misc/lubricator.ogg')
		M.gib(1, 1, 1) //dead
