...
/mob/living/carbon/human
	...
	hud_possible = list(HEALTH_HUD,STATUS_HUD,SENSOR_HUD,ID_HUD,WANTED_HUD,
						IMPLOYAL_HUD,IMPCHEM_HUD,IMPTRACK_HUD, NANITE_HUD,
						DIAG_NANITE_FULL_HUD,ANTAG_HUD,GLAND_HUD,SENTIENT_DISEASE_HUD,
						FAN_HUD,POLISH_HUD,UKRAINIAN_HUD,SEC_PING)
