...
/mob/living/simple_animal/hostile/floor_cluwne/electrocute_act(shock_damage, obj/source, siemens_coeff = 1, flags = SHOCK_TESLA)//prevents runtimes with machine fuckery
	return FALSE
