...
/mob/living/simple_animal/hostile/eldritch/maid_in_the_mirror
...
/mob/living/simple_animal/hostile/eldritch/maid_in_the_mirror/death(gibbed)
	var/turf/death_turf = get_turf(src)
	death_turf.TakeTemperature(-40)
	return ..()

// Examining them will harm them, on a cooldown.
/mob/living/simple_animal/hostile/eldritch/maid_in_the_mirror/examine(mob/user)
	. = ..()
	if(!weak_on_examine)
		return
...
/mob/living/simple_animal/hostile/eldritch/maid_in_the_mirror/proc/clear_recent_examiner(mob_ref)
