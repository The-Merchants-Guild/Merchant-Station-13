...
/datum/eldritch_knowledge/limited_amount/risen_corpse/recipe_snowflake_check(mob/living/user, list/atoms, list/selected_atoms, turf/loc)
	. = ..()
	if(!.)
		return FALSE
...
/datum/eldritch_knowledge/limited_amount/risen_corpse/proc/make_risen(mob/living/user, mob/living/carbon/human/victim)
...
/datum/eldritch_knowledge/limited_amount/risen_corpse/proc/apply_to_risen(mob/living/risen)
...
/datum/eldritch_knowledge/limited_amount/risen_corpse/proc/remove_from_risen(mob/living/risen)
...
/datum/eldritch_knowledge/summon/maid_in_mirror
	...
	cost = 1
	route = PATH_SIDE
	mob_to_summon = /mob/living/simple_animal/hostile/eldritch/maid_in_the_mirror
