...
/datum/quirk/item_quirk/finnish
	name = "Finland Enthusiast"
	...
	medical_record_text = "Patient mentions archeology in the Finnish nuclear wastelands as a stress-relieving hobby."

/datum/quirk/item_quirk/finnish/add_unique()
	give_item_to_holder(/obj/item/clothing/mask/spurdo, list(LOCATION_BACKPACK = ITEM_SLOT_BACKPACK, LOCATION_HANDS = ITEM_SLOT_HANDS))
...
/datum/quirk/waddle
	...
	value = 0
	medical_record_text = "Patient has Essential Tremor Disorder."
