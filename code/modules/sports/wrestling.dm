...
/obj/item/clothing/glasses/wrestling
	...
	worn_icon_state = "wrestlinggoggles"
	flash_protect = 2
	flags_cover = GLASSESCOVERSEYES
	visor_flags_inv = HIDEEYES
	glass_colour_type = /datum/client_colour/glass_colour/gray

/obj/item/clothing/under/syndicate/wrestling
...
/datum/action/slam/var/action_icon = 'icons/hud/actions.dmi'
/datum/action/strike/var/action_icon = 'icons/hud/actions.dmi'
/datum/action/kick/var/action_icon = 'icons/hud/actions.dmi'
/datum/action/throw_wrassle/var/action_icon = 'icons/hud/actions.dmi'
