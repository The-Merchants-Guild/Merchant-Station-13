...
/obj/item/clothing/head/helmet/space/hardsuit/nano/nanoguy
	...
	icon = 'icons/obj/nanoguy.dmi'
	//alternate_worn_icon = 'hippiestation/icons/mob/nanoguy.dmi'
	icon_state = "nghelmet"
	worn_icon_state = "nghelmet"
...
/obj/item/twohanded/required/nanoshield/Initialize()
	...
	AddComponent(/datum/component/two_handed, force_unwielded=20, force_wielded=20)
...
/obj/item/shield/captain_nt
	...
	righthand_file = 'icons/mob/inhands/items_righthand.dmi'
	icon_state = "ntshield"
	worn_icon_state = "ntshield"
	throw_range = 6
	force = 25
	throwforce = 30
	w_class = WEIGHT_CLASS_SMALL //haha don't worry about this one
	throw_speed = 3
	attack_verb_continuous = list("shoved", "bashed")
